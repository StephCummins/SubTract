...
const UpdateAvatarPage = ({
  ...
  // const loadAvatar = (temp) => {
  //   try {
  //     const response = fetch('/user/loadtempavatar?image=${temp}');
  //     if (!response.ok) throw response;
          ...
          >
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                ...
                {/* {userAvatar && (
                  <img alt="user avatar" src={userAvatar} width="96px" />
                )}
                {tempAvatar && (
                  <img
                    alt="user avatar"
                    src={`/user/loadtempavatar/${tempAvatar}`}
                    width="96px"
                  />
                )} */}
              </Grid>
...
//           >
//             <Grid container spacing={2}>
//               <img alt="user avatar" src={user.picture} width="96px" />
//               <Grid item xs={12} sm={6}>
